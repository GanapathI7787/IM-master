...
public class TextWebSocketFrameHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    public void userEventTriggered(ChannelHandlerContext ctx, Object evt) throws Exception {
        if (evt instanceof WebSocketServerProtocolHandler.ServerHandshakeStateEvent) {
            System.out.println(String.format("[事件-握手] %s", evt.toString()));
        } else if (evt instanceof WebSocketServerProtocolHandler.HandshakeComplete) {
            System.out.println(String.format("[事件-握手完成] %s", evt.toString()));
        } else if (evt instanceof IdleStateEvent) {
            System.out.println(String.format("[事件-心跳] %s", evt.toString()));
            Channel channel = ctx.channel();
            ...
            System.out.println(String.format("[事件-未定义] %s", evt.toString()));
        }
